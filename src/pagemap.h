...
struct pmArray {
	struct pmEntry pmEntry[DIE_NUM][PAGE_NUM_PER_DIE];			// 16 * (256*4096 = 1048576) = 16777216 => 2^24 => 1000000000000000000000000
																// 2^24 * 8byte = 128 MB -- as each Entry page is 8 byte
};
...
#define PAGE_MAP_ADDR	(RAM_DISK_BASE_ADDR + (0x1 << 27)) 		// PAGE_MAP_ADDR   => (0x10000000 + (0x1 << 27)) = 0x18000000
...
#define BAD_BLOCK_MARK_POSITION	(7972) 				// This represents the offset of the bad block marker
