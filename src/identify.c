...
{
	DebugPrint("<====Entering GetIdentifyDataCheckSum====>\r\n");
	...
	DebugPrint("<====Leaving GetIdentifyDataCheckSum====>\r\n");
...
void SetIdentifyData(P_IDENTIFY_DEVICE_DATA IdentifyData, P_HOST_CMD hostCmd )
{
	...
	IdentifyData->CheckSum = GetIdentifyDataCheckSum(IdentifyData);
	DebugPrint("<====Leaving SetIdentifyData====>\r\n");

}

void IdentifyDataByteOrderCopy( u32 * host, u32 * device, u32 size)
{
	DebugPrint("<====Entering IdentifyDataByteOrderCopy====>\r\n");
	...
	DebugPrint("<====Leaving IdentifyDataByteOrderCopy====>\r\n");
